---
title: "Mainfig_FLARE_vs_RFMix_correlation"
...
g_corr_p <- corr_p |> ggplot(aes(x = Position, y = Corr_afr_p)) +
  ...
  scale_color_manual(values = c("Amerindian" = "#D95F02", "African" = "#1B9E77",
                                "European" = "#7570B3"),
                     name = "Ancestry") +
  labs(y = "Local Ancestry Counts Correlation - FLARE3 vs. RFMix")+
...
g_corr_p <- corr_p |> ggplot(aes(x = Position, y = Corr_afr_p)) +
  ...
  scale_color_manual(values = c("Amerindian" = "#D95F02", "African" = "#1B9E77",
                                "European" = "#7570B3"),
                     name = "Ancestry") +
  labs(y = "Local Ancestry Counts Correlation - FLARE7 vs. RFMix")+
  theme(axis.text.x =  element_blank(),
        axis.title.x = element_blank(),
        axis.ticks.x = element_blank(),
        legend.position = "top",
