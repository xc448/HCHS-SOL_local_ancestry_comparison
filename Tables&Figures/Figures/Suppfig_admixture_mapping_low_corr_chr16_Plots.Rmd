---
title: "Admixture mapping result of propyl 4-hydroxybenzoate sulfate, focusing on African ancestry at chromosome 16"
...
plot_overlay_pval <- function(metab, batch, ancestry, chr, inference){
  ...
  res_RFMix <- readRDS(paste0("./admix_map_all/admixmap_low_corr/RFMix_res_", ancestry,
  ...
  load(paste0("./admix_map_all/admixmap_low_corr/", metab, inference, "_", ancestry, "_b", batch, "_chr", chr, ".Rdata"))
