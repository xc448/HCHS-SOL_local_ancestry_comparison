---
title: "Suppfig_FLARE3_RFMix_correlation+mean+var_proportion"
author: "Xueying Chen"
date: "2024-07-15"
...
g_corr_p <- corr_p |> ggplot(aes(x = Position, y = Corr_afr_p)) +
  ...
  scale_color_manual(values = c("Amerindian" = "#D95F02", "African" = "#1B9E77",
                                "European" = "#7570B3"),
                     name = "Ancestry") +
  labs(y = "Local Ancestry Counts Correlation")+
...
#ggsave(g_corr_p, file = "../Figures/Correlation_old_FLARE3.png", width = 12, height = 8)
g_corr_p
```
...
# ggsave(g_prop_afr, file = "./prop_afr.pdf", width = 6, height = 4.5,
#        device = cairo_pdf)
