...
# Load the liftOver BED file for the old local ancestry interval annotations - RFMix inference
...
# Subsetting and matching subject IDs in the RFMix dataset
...
# Subsetting FLARE7 counts by matching subject IDs
...
# Initiate a variable to store correlation results
corr_result <- c()

# Define a function computing mean ancestry proportion / ancestry 
